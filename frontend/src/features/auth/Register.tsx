        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-9 pr-3 py-2.5 rounded-xl border bg-slate-50 dark:bg-[#111622] text-sm focus:outline-none focus:ring-1 transition-all ${
                errors.firstName
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            disabled={registerMutation.isPending}
            className={`w-full pl-10 pr-4 py-2.5 rounded-xl border bg-slate-50 dark:bg-[#111622] text-sm focus:outline-none focus:ring-1 transition-all ${
              errors.email
                ? 'border-finance-expense/30 focus:border-finance-expense focus:ring-finance-expense'
                : 'border-border-light dark:border-border-dark focus:border-brand-primary focus:ring-brand-primary'
            }`}
